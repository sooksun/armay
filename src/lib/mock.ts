...
export const RENTAL_STEP_DATA: { title: string; desc: string; fields: StepField[] }[] = [
  {
    ...
    fields: [
      { label: "ผู้เช่า", value: "คุณกิตติพงษ์ ใจดี", color: "var(--text)", icon: "search" },
      { label: "เบอร์โทร", value: "081-234-5678", color: "var(--text)" },
      { label: "เลขบัตรประชาชน", value: "1-2345-67890-12-3", color: "var(--text)" },
      { label: "อีเมล", value: "kitti@email.com", color: "rgba(var(--text-rgb),0.5)" },
    ],
  },
  {
    title: "เลือกห้อง",
    ...
    fields: [
      { label: "อาคาร", value: "เดอะ เครสท์ สุขุมวิท", color: "var(--text)", icon: "chevDown" },
      { label: "ห้อง", value: "A-1105 (ว่าง)", color: "var(--text)", icon: "chevDown" },
      { label: "เจ้าของ (อัตโนมัติ)", value: "คุณสมชาย วัฒนโสภณ", color: "var(--pos)" },
      { label: "ค่าเช่าปกติ", value: "฿12,500/เดือน", color: "var(--pos)" },
    ],
  },
  {
    ...
    fields: [
      { label: "วันที่เริ่ม", value: "1 ก.ค. 2568", color: "var(--text)", icon: "cal" },
      { label: "วันที่สิ้นสุด", value: "31 ก.ค. 2568", color: "var(--text)", icon: "cal" },
      { label: "ค่าเช่า", value: "฿12,500", color: "var(--pos)" },
      { label: "เงินประกัน", value: "฿24,000", color: "var(--text)" },
      { label: "ค่าทำความสะอาด", value: "฿800", color: "var(--text)" },
      { label: "ส่วนลด", value: "฿0", color: "rgba(var(--text-rgb),0.5)" },
    ],
  },
  {
    ...
    fields: [
      { label: "ยอดรวมทั้งสิ้น", value: "฿37,300", color: "var(--pos)" },
      { label: "ต้องชำระตอนนี้", value: "฿37,300", color: "var(--pos)" },
      { label: "ประเภทการเช่า", value: "รายเดือน", color: "var(--text)" },
...
export const PAYOUT_CALC_ROWS: CalcRow[] = [
  { label: "รายรับรวมของห้อง A-1105", amount: "฿12,500", labelColor: "rgba(var(--text-rgb),0.8)", amountColor: "var(--text)", bold: false, top: false },
  { label: "หัก ค่านายหน้า (10%)", amount: "− ฿1,250", labelColor: "rgba(var(--text-rgb),0.7)", amountColor: "var(--neg)", bold: false, top: true },
  { label: "หัก ค่าแม่บ้าน", amount: "− ฿800", labelColor: "rgba(var(--text-rgb),0.7)", amountColor: "var(--neg)", bold: false, top: true },
  { label: "หัก ค่าซ่อมก๊อกน้ำ", amount: "− ฿1,300", labelColor: "rgba(var(--text-rgb),0.7)", amountColor: "var(--neg)", bold: false, top: true },
  { label: "หัก ค่าธรรมเนียมโอน", amount: "− ฿15", labelColor: "rgba(var(--text-rgb),0.7)", amountColor: "var(--neg)", bold: false, top: true },
  { label: "ยอดสุทธิจ่ายเจ้าของ", amount: "฿9,135", labelColor: "var(--pos)", amountColor: "var(--pos)", bold: true, top: true },
];

export const PAYOUT_FIELDS_BY_STEP: Record<number, StepField[]> = {
  1: [
    { label: "เจ้าของ", value: "คุณสมชาย วัฒนโสภณ", color: "var(--text)", icon: "search" },
    { label: "จำนวนห้องในความดูแล", value: "4 ห้อง", color: "var(--pos)" },
    { label: "บัญชีรับเงิน", value: "KBank · 123-4-56789", color: "var(--text)" },
    { label: "ยอดค้างจ่ายสะสม", value: "฿142,000", color: "#FDE68A" },
  ],
  2: [
    { label: "ห้อง", value: "A-1105", color: "var(--text)", icon: "chevDown" },
    { label: "รายการเช่า", value: "RN-2568-0142", color: "var(--text)", icon: "chevDown" },
    { label: "งวด", value: "ก.ค. 2568", color: "var(--text)" },
    { label: "รายรับที่เกี่ยวข้อง", value: "฿12,500", color: "var(--pos)" },
  ],
  5: [
    { label: "จำนวนที่จ่ายจริง", value: "฿9,135", color: "var(--pos)" },
    { label: "วันที่จ่าย", value: "6 ก.ค. 2568", color: "var(--text)", icon: "cal" },
    { label: "ช่องทางจ่าย", value: "โอนธนาคาร", color: "var(--text)", icon: "chevDown" },
    { label: "บัญชีเจ้าของ", value: "KBank · 123-4-56789", color: "var(--text)" },
    { label: "เลขอ้างอิง", value: "TXN20680706-0091", color: "var(--text)" },
    { label: "แนบสลิป", value: "slip-9135.jpg", color: "var(--pos)", icon: "upload" },
  ],
};
